...
CREATE INDEX IF NOT EXISTS i_i_user_team ON Installations(user_id, team_id);
...
CREATE INDEX IF NOT EXISTS i_us_install ON UserSessions(install_id);
...
CREATE INDEX IF NOT EXISTS i_r_install ON Requests(install_id);
-- create functions
